...
- **Author:** Claude    **Reviewer:** {{who}}    **Approved:** {{YYYY-MM-DD}}
...
- **MCP / tools:** {{any MCP servers or external tools Claude needs at build/run time}}
...
## Deploy & governance
- **Execution:** {{how it ships — CI job, `claude -p` (headless) in pipeline, manual}}
- **Permission mode at deploy:** {{default | plan | acceptEdits | bypassPermissions}}
...
<!-- On approval: set Status=approved, commit. Claude then runs stage 3 (Build). -->
